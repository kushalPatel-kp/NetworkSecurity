...
class TrainingPipelineConfig:
    def __init__(self, timestemp=datetime.now()):
        timestemp = timestemp.strftime("%m_%d_%Y_%H_%M_%S")
        self.pipeline_name = training_pipeline.PIPELINE_NAME
        self.artifact_name = training_pipeline.ARTIFACT_DIR
        self.artifact_dir=os.path.join(self.artifact_name,timestemp)
...
class DataValidationConfig:
    def __init__(self, train_pipeline_config=TrainingPipelineConfig):
        ...
        self.invalid_test_file_path:str=os.path.join(self.data_validation_invalid_dir, training_pipeline.TRAIN_FILE_NAME)
